							...
							<div className="mx-auto container grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden md:px-20">
								<motion.div
									...
									<motion.p
										...
										Hi! I&rsquo;am Aniket,A passionate Full Stack Developer skilled in the MERN stack and Next.js, focused on building fast, scalable, and modern web applications. Always exploring new technologies and integrating AI to create smarter digital experiences.
									</motion.p>
									<motion.div
										...
										<Button variation="primary">
											<Link
												href="https://drive.google.com/file/d/1RrsKm-iwyzdWFmIEX4e2vvwi9U6C4sVd/view?usp=sharing"
												target="_blank"
							...
							<div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
								...
								<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
									...
									<motion.p
										...
										<a href="mailto:aniketchaturvedi83@gmail.com?subject=Hello&body=Hello Aniket,">
											aniketchaturvedi83@gmail.com
										</a>
									</motion.p>
									{/* icons */}
									<div className="flex justify-center items-center space-x-4">
										<motion.a
											href="mailto:aniketchaturvedi83@gmail.com?subject=Hello&body=Hello Aniket,"
										...
										<motion.a
											href="https://github.com/Anikett77"
											target="_blank"
											rel="noopener noreferrer"
											className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
