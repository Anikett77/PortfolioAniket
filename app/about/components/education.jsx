...
import Me6 from "@/public/image/me2.jpg";
		...
		2025: [
			{
				icon: faAward,
				title: "Participant",
				subtitle: "36 Hours Version Beta 8.0 Hackathon, MANIT Bhopal",
				date: "Nov 2025",
				color: "from-blue-500 to-purple-600",
			},
			{
				icon: faAward,
				title: "Certified in GenAI Workshop",
				subtitle: "Decode Data Academy",
				date: "Oct 2025",
				color: "from-green-400 to-emerald-600",
			},
			{
				icon: faMedal,
				title: "Certified in Graphic Design Essentials",
				subtitle: "Coursera",
				date: "Sep 2025",
			...
			{
				icon: faAward,
				title: "Certified in Build a Website with WordPress",
				subtitle: "Coursera",
				date: "Aug 2025",
			...
			},
			{
				icon: faMedal,
				title: "Finalist",
				subtitle: "CodeQueue 2.0 – TIT Bhopal (CodeSprint)",
				date: "Jun 2025",
			...
			},
			{
				...
				subtitle: "Google Cloud Arcade Program",
				date: "May 2025",
				color: "from-sky-500 to-cyan-600",
			},
			{
				icon: faMedal,
				title: "Cypher 30 – 30 Days Coding Challenge",
				subtitle: "Cypher Community",
				date: "Apr 2025",
				color: "from-purple-500 to-fuchsia-600",
			},
			{
				icon: faAward,
				title: "Naukri Aptitude Test",
				subtitle: "Aincat 2025",
				date: "Mar 2025",
				color: "from-blue-500 to-purple-600",
			},
			{
						...
						<div>
							...
							<div className="flex items-center gap-2">
								<p className="text-gray-600 text-justify title text-lg">
									Driven by curiosity and creativity, I’m currently pursuing my Bachelor’s degree in{" "}
									<span className="text-black font-medium">Computer Science and Engineering (AI & ML)</span>{" "}
									at{" "}
									<span className="text-black font-medium">Oriental Institute of Science and Technology, Bhopal</span>.
									My journey in technology revolves around building innovative, scalable web applications
									while exploring the fascinating world of{" "}
									<span className="text-black font-medium">Artificial Intelligence</span> and{" "}
									<span className="text-black font-medium">Machine Learning</span>.
									<br />
									<br />
									I have hands-on experience in{" "}
									<span className="text-black font-medium">MERN Stack Development</span> and a deep interest
									in integrating{" "}
									<span className="text-black font-medium">AI models and LLMs</span> into modern web systems.
									Throughout my learning journey, I’ve actively worked on various projects, including
									web applications and AI-based solutions, enhancing my problem-solving and teamwork skills.
									<br />
									<br />
									As an aspiring developer, I’m passionate about bridging the gap between{" "}
									<span className="text-black font-medium">Web Development</span> and{" "}
									<span className="text-black font-medium">Artificial Intelligence</span>.
									I believe in constant learning, experimenting with new technologies, and contributing
									to meaningful digital innovations that make a difference.
								</p>
							</div>
