...
const experiences = [
	{
		...
		position: "Helping Hand Foundation",
		type: "Freelance",
		location: "Remote",
		description:
			"Designed creative visual content, including logos, posters, and social media graphics. Focused on delivering visually appealing and brand-consistent designs while collaborating with teams to enhance overall digital presence.",
		skills: [
			"Adobe Photoshop",
			"Adobe Illustrator",
			"Canva",
	...
	},
	{
		...
		startDate: "Sep 2024",
		endDate: "Oct 2024",
		company: "Startup Sprint Ideathon",
		position: "Oriental Institute of Science and Technology",
		type: "",
		location: "Bhopal",
		description:
...

	{
		...
		startDate: "Aug 2025",
		endDate: "One Day",
		company: "Imprenditore 4.0",
		position: "Startup Sprint: AI Based Hackathon",
		type: "",
		location: "RGPV, Bhopal",
		description:
			"Participated in the RGPV Hackathon, where I collaborated with a team to design and develop an AI-integrated web application within 36 hours. Focused on implementing innovative features using MERN stack and generative AI tools to solve real-world challenges efficiently.",
		skills: [
			"React",
			"Next.js",
			"Node.js",
	...
	},
	{
		...
		startDate: "Nov 2025",
		endDate: "36 Hours",
		company: "Version Beta 8.0 ",
		position: "36-Hours Hackathon",
		type: "",
		location: "MANIT, Bhopal",
		description:
			"Participated in a 36-hour hackathon at MANIT, collaborating in a team of four to develop an innovative web application from scratch. Focused on problem-solving, rapid prototyping, and integrating creative tech solutions under tight deadlines.",
		skills: [
			"React",
			"Next.js",
			"MERN",
	...
	},
	{
		...
		location: "Bhopal",
		description:
			"Represented the institution as a Campus Ambassador, bridging communication between students and organizations. Promoted events, managed outreach campaigns, and helped increase student participation in tech programs. Developed leadership, communication, and marketing skills through active collaboration and coordination.",
		skills: [
			"Leadership",
			"Public Speaking",
			"Event Promotion",
